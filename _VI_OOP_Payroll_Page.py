...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #changed button gross, net, save, update button
    gross_income_button = my_gui_design.button_design(frame, 1132, 1001, 150, 36, "#CAF4FF", "white", "GROSS INCOME", ('Century Gothic', 13))
    gross_income_button.config(command=grossIncome)
    net_income_button = my_gui_design.button_design(frame, 1297, 1001, 130, 36, "#CAF4FF", "white", "NET INCOME", ('Century Gothic', 13))
    net_income_button.config(command=netIncome)
    save_button = my_gui_design.button_design(frame, 1442, 1001, 106, 36, "#A0DEFF", "white", "SAVE", ('Century Gothic', 13))
    save_button.config(command=saveData)
    update_button = my_gui_design.button_design(frame, 1563, 1001, 106, 36, "#AODEFF", "white", "UPDATE", ('Century Gothic', 13))
