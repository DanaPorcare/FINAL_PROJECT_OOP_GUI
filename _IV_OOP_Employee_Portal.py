...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    account_button = gui.button_design(main_frame, 1174, 88, 495, 104, "white", "black", " ACCOUNT",("Century Gothic", 30, 'bold'))
    account_button.config(image=account_image, compound=tk.LEFT, relief=tk.FLAT, activebackground="white", command=switch_to_account_page)
